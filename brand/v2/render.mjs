// Renders the v2 sheet and PNG exports. usage: python brand/v2/make.py && node brand/v2/render.mjs
...
for (const [src, out, w, h] of [['mark.svg', 'mark.png', 1644, 1200], ['icon.svg', 'icon-1080.png', 1080, 1080]]) {
