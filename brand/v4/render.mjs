// Renders v3 PNGs. usage: python brand/v4/make.py && node brand/v4/render.mjs
...
for (const [src, out, w, h] of [['logo-paper.svg', 'logo.png', 2000, 1380], ['icon.svg', 'icon-1080.png', 1080, 1080], ['logo-reversed.svg', 'logo-reversed.png', 2000, 1380]]) {
