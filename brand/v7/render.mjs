// Renders the v7 sheet and a 1080px PNG of each mark. usage: python brand/v7/make.py && node brand/v7/render.mjs
...
const names = ['haviv-crop', 'haviv-bezier', 'haviv-register', 'bierut-eyes', 'bierut-bubble', 'bierut-swatch', 'jetset-stop', 'jetset-select', 'jetset-cursor'];
